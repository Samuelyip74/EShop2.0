...
from .views import ProductVariantListView,CategoryListView,ProductListingByCategory,ProductVariantListDetail
...
urlpatterns = [
    ...
    url(r'^variant/(?P<slug>[\w-]+)/$', ProductVariantListDetail.as_view(), name='api_productdetailview'),
